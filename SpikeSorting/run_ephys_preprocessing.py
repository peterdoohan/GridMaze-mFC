...
def get_ephys_preprocessing_SLURM_script(ephys_info, spike_sorter="Kilosort4", RAM="64GB", time_limit="48:00:00", 
                                        ...
                                        jobs_folder = JOBS_FOLDER, python_path = '.',import_path = 'SpikeSorting'): #options to edit jobs folder and python path when running tests.
...
PYTHONPATH='{python_path}' python -c \"import {import_path}.spikesort_session as sps; sps.preprocess_ephys_session('{ephys_info.subject_ID}', '{ephys_info.datetime.isoformat()}', '{ephys_info.ephys_path}', {IBL_preprocessing}, {kilosort_Ths}, spikesort_path='{spikesort_path}')\"
"""
