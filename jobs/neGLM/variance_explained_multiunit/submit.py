...
def submit_jobs(seed=0, subfolder="variance_explained_multiunit"):
...
def get_model_set_params(seed=0, subfolder="variance_explained_multiunit"):
    model_set_params = []
    ...
    for maze_name in ["maze_1", "maze_2", "rooms_maze"]:
        for remove_groups, input_group_kwargs, model_name in [
            ...
            input_data_kwargs["min_spike_count"] = 300
            input_data_kwargs["include_multiunit"] = True  # Note difference here :)
